...
import { MOCK_IMAGE, MOCK_PERSON, MOCK_SHORT_PERSON_DATA } from "./constants";
...
describe('PeopleController', () => {
    ...
    describe('createPerson', () => {
        it('should create a new person', async () => {
            ...
            let result = await peopleController.createPerson(createPeopleDto);
    ...
    describe('getPeople', () => {
        it('should return a 10 people', async () => {
            const page = 1;
            const tenPeople = [MOCK_PERSON, MOCK_PERSON, MOCK_PERSON, MOCK_PERSON, MOCK_PERSON,
                MOCK_PERSON, MOCK_PERSON, MOCK_PERSON, MOCK_PERSON, MOCK_PERSON];
            const expectedResult = [MOCK_SHORT_PERSON_DATA, MOCK_SHORT_PERSON_DATA, MOCK_SHORT_PERSON_DATA,
                MOCK_SHORT_PERSON_DATA, MOCK_SHORT_PERSON_DATA, MOCK_SHORT_PERSON_DATA, MOCK_SHORT_PERSON_DATA,
                MOCK_SHORT_PERSON_DATA, MOCK_SHORT_PERSON_DATA, MOCK_SHORT_PERSON_DATA];

            jest.spyOn(peopleService, 'getItemsFromThePage').mockResolvedValue(tenPeople);
            jest.spyOn(peopleService, 'setItemDataForResponse').mockReturnValueOnce(MOCK_SHORT_PERSON_DATA as never);
    ...
    describe('updatePerson', () => {
        it('should return updated person', async () => {
            ...
            let result = await peopleController.updatePerson(1, updatedData) as People;
    ...
    describe('deletePerson', () => {
        it('should return deleted person', async () => {
            ...
            let result = await peopleController.deletePerson(1) as People;
    ...
    describe('downloadImages', () => {
        it('should return person with downloaded images', async () => {
            let expectedResult = MOCK_PERSON;
            expectedResult.images = [MOCK_IMAGE];

            let createImageDto: ImagesDto = { urls: [MOCK_IMAGE.url] };
            jest.spyOn(peopleService, 'getItem').mockResolvedValue(MOCK_PERSON);
            jest.spyOn(peopleService, 'downloadItemImages').mockResolvedValue(expectedResult);

            let result = await peopleController.downloadImages(createImageDto, MOCK_PERSON.id) as People;
    ...
    describe('deleteImages', () => {
        it('should return person without deleted images', async() => {
            let personWithoutImage = {...MOCK_PERSON};
            ...
            let result = await peopleController.deleteImages(MOCK_PERSON.id, MOCK_IMAGE.id) as People;
    ...
    describe('getPerson', () => {
        it('should return person', async () => {
            ...
            let result = await peopleController.getPerson(MOCK_PERSON.id) as People;
