...
export class FilmsController {
    ...
    async updateFilm(@Param('id') filmId: number,
        ...
        let filmToUpdate = await this.filmsService.getItem(Number(filmId));
    ...
    async downloadImages(@Body() imagesData: ImagesDto,
        @Param('id') filmId: number): Promise<Partial<OneOfItems>> {
    ...
    @UseGuards(LocalAuthGuard, RolesGuard)
    @Roles(Role.Admin)
    async deleteImages(@Param('filmId') filmId: number,
