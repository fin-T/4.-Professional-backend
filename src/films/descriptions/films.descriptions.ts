export const CREATE = `To create a movie, you must pass the request body with the required <b>title</b> field.<br>
...
export const DELETE_IMAGES = `Removing links (urls) to images by film and image identifiers.
        <br><br>
        This route is only available to administrators (with role "admin").`;
